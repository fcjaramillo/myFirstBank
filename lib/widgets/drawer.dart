    ...
    return Drawer(
        child: ListView(
          ...
          children: <Widget>[
            ...
            _createDrawerItem(context: context, icon: Icons.qr_code, color: MFBColors.grayIcon, text: 'Crear Codigo Qr', onTap: () => {onTap('generate')}),
            _createDrawerItem(context: context, icon: Icons.qr_code_scanner, color: MFBColors.grayIcon, text: 'Scan Codigo Qr', onTap: () => {onTap('scan')}),
            Divider(),
